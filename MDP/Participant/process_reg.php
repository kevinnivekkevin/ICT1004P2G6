...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) { // If everything's OK.     
        ...
        // Make the query:
        $q = "INSERT INTO vending.acc (first_name, last_name, username, email, dob_day, dob_month, dob_year, gender, pass, registration_date) VALUES ('$fn', '$ln', '$un', '$e', '$d', '$m', '$y', '$g', SHA1('$p'), NOW() )";      
        ...
        {   echo "<h2>Oops!</h2>";
            ...
            echo "<a href='register.php' class='btn btn-warning' type>Return to Sign Up</a>";
